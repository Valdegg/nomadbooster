...
import sys
import os
# Add the root directory to sys.path to access datasource_integrations
sys.path.append(os.path.join(os.path.dirname(__file__), '..', '..'))
from datasource_integrations.airbnb_accommodation_costs import fetch_airbnb_data_for_city
